...
public class MainController {
    ...
    @Value("${social.naver.redirect-url}")
    ...
    public String kakaoLogin() {
        return "redirect:https://kauth.kakao.com/oauth/authorize?client_id=ff5fbe39cb292ecd96bd27eb8415bf9a&redirect_uri="+kakaoRedirectUrl+"/login/oauth/kakao&response_type=code";
    }
    ...
    public String naverLogin(HttpSession session) {
        ...
        return "redirect:https://nid.naver.com/oauth2.0/authorize?client_id=pcoAzgHoNqxyxgYcRFuv&redirect_uri="+naverRedirectUrl+"/login/oauth/naver&state="+state+"&response_type=code";
    }
    ...
    public String logout(HttpSession session) {
        if(session.getAttribute("user") != null) {
            ...
            if(socialType == SocialType.KAKAO) {
                return "redirect:https://kauth.kakao.com/oauth/logout?client_id=ff5fbe39cb292ecd96bd27eb8415bf9a&logout_redirect_uri="+kakaoRedirectUrl+"/logout/oauth/kakao";
    ...
    public String kakaoAuthCode(@RequestParam(value="code", required = false) String code,
        ...
        String accessToken = kakaoService.getKakaoAccesstoken(code,kakaoRedirectUrl);
    ...
    public String naverAuthCode(@RequestParam(value="code", required = false) String code,
        ...
        String naverAccessToken = naverService.getNaverAccessToken(code, state,naverRedirectUrl);
